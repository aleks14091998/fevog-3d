...
CGeometryBufferGL43::CGeometryBufferGL43(char* fileName) {
	setup();
}

CGeometryBufferGL43::~CGeometryBufferGL43() {

}

void CGeometryBufferGL43::setup() {
...
void CGeometryBufferGL43::bind() {
	gl::BindVertexArray(VAO);
	gl::EnableVertexAttribArray(0);
	gl::EnableVertexAttribArray(1);
	gl::EnableVertexAttribArray(2);

	gl::DrawArrays(gl::TRIANGLES, 0, 12 * 3); /// поправить
